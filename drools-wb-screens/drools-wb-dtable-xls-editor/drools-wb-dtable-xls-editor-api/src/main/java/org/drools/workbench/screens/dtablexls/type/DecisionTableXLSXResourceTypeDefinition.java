...
@VisibleAsset
@ApplicationScoped
public class DecisionTableXLSXResourceTypeDefinition
        implements ResourceTypeDefinition {

    private Category category;

    public DecisionTableXLSXResourceTypeDefinition() {
    }

    @Inject
    public DecisionTableXLSXResourceTypeDefinition(final Decision category) {
