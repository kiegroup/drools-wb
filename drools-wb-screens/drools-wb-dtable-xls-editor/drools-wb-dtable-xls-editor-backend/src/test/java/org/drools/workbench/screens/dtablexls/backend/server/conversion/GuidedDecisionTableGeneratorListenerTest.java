...
public class GuidedDecisionTableGeneratorListenerTest {
    ...
    private void checkConversionWithBigMaths(final ConversionResult result,
                                             ...
                                             final Object expectedDataValueRow0,
                                             final Object expectedDataValueRow1) {
        ...
        assertEquals(2,
                     dtable.getData().size());
        assertTrue(isRowEquivalent(new Object[]{1, "Hello World", "Message.HELLO", false, "Goodbye cruel world", "Message.GOODBYE", expectedDataValueRow0, "m"},
                                   dtable.getData().get(0)));
        assertTrue(isRowEquivalent(new Object[]{2, "Goodbye", "Message.GOODBYE", false, "", "", expectedDataValueRow1, "m"},
                                   dtable.getData().get(1)));
    }
