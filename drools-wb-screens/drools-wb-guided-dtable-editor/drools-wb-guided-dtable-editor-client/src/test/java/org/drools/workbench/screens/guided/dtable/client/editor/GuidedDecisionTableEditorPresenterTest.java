...
public class GuidedDecisionTableEditorPresenterTest {
    ...
    @Mock
    GuidedDecisionTableEditorService service;

    GuidedDecisionTableEditorPresenter presenter;
    ...
    public void setUp() throws Exception {
        presenter = new GuidedDecisionTableEditorPresenter(mock(GuidedDecisionTableEditorView.class)) {
            {
                service = new CallerMock<>(GuidedDecisionTableEditorPresenterTest.this.service);
