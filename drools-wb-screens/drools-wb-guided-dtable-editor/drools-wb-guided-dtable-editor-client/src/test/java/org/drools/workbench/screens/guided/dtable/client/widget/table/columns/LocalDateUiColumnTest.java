...
public class LocalDateUiColumnTest {

    private static final String TEST_DATE_FORMAT = "MM-dd-yyyy HH:mm:ss";

    @Mock
    private LocalDatePickerSingletonDOMElementFactory factory;
    ...
    public void testDateUiColumnTextFormat() {
        ...
        final String clientDate = "05-01-2018 00:00:00";

        renderer().doRenderCellContent(text, clientDate, context);

        verify(text).setText(clientDate);
    }

    private BaseSingletonDOMElementUiColumn.CellRenderer<String, DatePicker, LocalDatePickerDOMElement> renderer() {
        return LocalDateUiColumn.makeColumnRenderer(factory);
    }
}
