...
public abstract class BaseGuidedDecisionTableEditorPresenter extends KieMultipleDocumentEditor<GuidedDecisionTableView.Presenter> {
    ...
    private final static DockPlaceHolderPlace DOCK_PLACE_HOLDER_PLACE = new DockPlaceHolderPlace(AnalysisDockPlaceHolder.IDENTIFIER,
                                                                                                 VERIFIER_DOCK);
    protected View view;
    ...
    protected void onStartup(final ObservablePath path,
        ...
        registerDock(this.DOCK_PLACE_HOLDER_PLACE,
