...
public class SetFieldColActionInspectorKey extends ActionInspectorKey {

    private String boundName;
    private String factField;

    public SetFieldColActionInspectorKey(ActionSetFieldCol52 actionCol) {
        super( actionCol );
    ...
    public boolean equals( Object o ) {
        if ( this == o ) {
            return true;
        } else if ( o instanceof SetFieldColActionInspectorKey) {
