...
public class IntegerGapsCheck {
    ...
    public IntegerGapsCheck(Collection<ConditionInspector> inspectors) {
        NumericIntegerConditionInspector inspector1 = null;
        for (ConditionInspector i : inspectors) {

            inspector1 = (NumericIntegerConditionInspector) i;
            scale.add(new Point(inspector1.getValue(), inspector1.getOperator()));
        }
    }

    public boolean hasGaps() {
        return scale.getGaps().isEmpty();
    }
}
