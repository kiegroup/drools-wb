...
public class ScoreCardXLSEditorPresenterTest {

    @Mock
    ScoreCardXLSService scoreCardXLSService;
    ...
    public void commandIsCalled() throws Exception {
        ...
        doReturn(new ArrayList<ValidationMessage>()).when(scoreCardXLSService).validate(any(Path.class),
                                                                                        any(Path.class));
    ...
    public void callFailsAndCommandIsCalled() throws Exception {
        ...
        doThrow(new IOException()).when(scoreCardXLSService).validate(any(Path.class),
                                                                      any(Path.class));
