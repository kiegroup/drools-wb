 ...
 */
@ApplicationScoped
public class TestGuidedDecisionTreeFileIndexer extends GuidedDecisionTreeFileIndexer implements TestIndexer<GuidedDTreeResourceTypeDefinition> {
    ...
    @Override
    public void setResourceTypeDefinition(final GuidedDTreeResourceTypeDefinition type) {
        this.type = type;
    }
    ...
    protected ProjectDataModelOracle getProjectDataModelOracle(final Path path) {
        ...
        dmo.addProjectModelFields(new HashMap<String, ModelField[]>() {{
            put("org.drools.workbench.screens.guided.dtree.backend.server.indexing.classes.Applicant",
                new ModelField[]{
                        new ModelField("age",
                                       "java.lang.Integer",
            ...
            put("org.drools.workbench.screens.guided.dtree.backend.server.indexing.classes.Mortgage",
                new ModelField[]{
