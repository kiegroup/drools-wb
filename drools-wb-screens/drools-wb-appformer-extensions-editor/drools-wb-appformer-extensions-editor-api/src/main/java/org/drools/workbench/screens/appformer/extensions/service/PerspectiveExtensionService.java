...
package org.drools.workbench.screens.appformer.extensions.service;
...
@Remote
public interface PerspectiveExtensionService
        extends
    ...
    PerspectiveExtensionContent loadContent(final Path path);
}
