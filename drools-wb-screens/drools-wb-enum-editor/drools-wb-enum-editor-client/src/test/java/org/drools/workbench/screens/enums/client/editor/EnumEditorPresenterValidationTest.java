...
public class EnumEditorPresenterValidationTest {

    @Mock
    EnumService service;

    EnumEditorPresenter presenter;

    @Before
    public void setUp() throws Exception {
        presenter = new EnumEditorPresenter(mock(EnumEditorView.class),
                                            new CallerMock<>(service),
                                            mock(EnumResourceType.class),
