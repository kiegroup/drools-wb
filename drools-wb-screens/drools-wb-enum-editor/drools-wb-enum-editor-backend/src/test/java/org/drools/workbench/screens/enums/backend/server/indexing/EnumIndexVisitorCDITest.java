...
public class EnumIndexVisitorCDITest extends CDITestSetup {
    ...
    public void testDependentEnumIndexing() throws Exception {
        ...
        final ProjectDataModelOracle oracle = indexer.getProjectDataModelOracle(testedPath);
        Assertions.assertThat(oracle.getProjectModelFields().keySet()).contains(carFQN);
