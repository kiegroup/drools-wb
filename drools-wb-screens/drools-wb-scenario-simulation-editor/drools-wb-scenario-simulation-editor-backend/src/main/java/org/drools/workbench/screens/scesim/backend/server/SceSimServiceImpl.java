...
@Service
@ApplicationScoped
public class SceSimServiceImpl
        extends KieService<SceSimModelContent>
        implements SceSimService {
    ...
    public SceSimServiceImpl() {
    }

    @Inject
    public SceSimServiceImpl(final SessionInfo sessionInfo) {
    ...
    @Override
    public SceSimModelContent loadContent(final Path path) {
        return super.loadContent(path);
    }

    @Override
    protected SceSimModelContent constructContent(Path path,
                                                  Overview overview) {
