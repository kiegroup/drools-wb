...
/**
 * JSInterop adapter for <code>BackgroundDataType</code>
 * 
 */
@JsType(namespace = JsPackage.GLOBAL, name = "JsInterop__ConstructorAPI__SCESIM__org__drools__workbench__scenariosimulation__kogito__marshaller__js__model__JSIBackgroundDataType", isNative = true)
public class JSIBackgroundDataType {

    @JsOverlay
    public final static String TYPE = "SCESIM.BackgroundDataType";
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("BackgroundDataType");
        toReturn.setPrefix("");
        toReturn.setKey("{}");
        toReturn.setString("{}BackgroundDataType");
        return toReturn;
    }
