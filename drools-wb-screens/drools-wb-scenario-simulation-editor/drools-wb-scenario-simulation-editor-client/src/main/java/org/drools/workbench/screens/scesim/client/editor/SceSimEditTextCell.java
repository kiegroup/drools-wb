...
public class SceSimEditTextCell extends EditTextCell {
    ...
    public void onBrowserEvent(final Context context,
        ...
        final SceSimRow sceSimRow = (SceSimRow) context.getKey();
        if (!sceSimRow.disabled()) {
    ...
    public void render(final Context context,
        ...
        if (!sceSimRow.disabled()) {
            ...
            if (!(value == null || value.isEmpty())) {
                sb.append(template.cellContent(SceSimEditorResources.INSTANCE.css().disabled(),
                                               SceSimEditorConstants.INSTANCE.invalidDefinitionDisabled(),
                                               value));
            } else {
                sb.append(template.cellContent(SceSimEditorResources.INSTANCE.css().disabled(),
                                               SceSimEditorConstants.INSTANCE.invalidDefinitionDisabled(),
