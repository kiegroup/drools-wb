 ...
 */
@Dependent
public class EnableTestToolsInstanceCommand extends AbstractScenarioSimulationCommand {

    public EnableTestToolsInstanceCommand() {
        super(false);
    }
    ...
    protected void internalExecute(ScenarioSimulationContext context) {
        ...
        if (context.getTestToolsPresenter() != null) {
            if (status.getFilterTerm() == null) {
                ...
                context.getTestToolsPresenter().onEnableEditorTab(status.getFilterTerm());
            }
        }
    }
}
