...
public class SetHeaderCellValueCommandTest extends AbstractScenarioGridCommandTest {
    ...
    public void recursivelyFindIsPropertyType() {
        Map<String, FactModelTree.SimpleType> bookSimpleProperties = new HashMap<>();
        bookSimpleProperties.put("name", new FactModelTree.SimpleType("String"));
        Map<String, String> bookExpandableProperties = new HashMap<>();
        bookExpandableProperties.put("author", "Author");
        Map<String, FactModelTree.SimpleType> authorSimpleProperties = new HashMap<>();
        authorSimpleProperties.put("books", new FactModelTree.SimpleType("List"));
    ...
    private FactModelTree getMockedFactModelTree(Map<String, FactModelTree.SimpleType> simpleProperties, Map<String, String> expandableProperties) {
    ...
    private void commonValidatePropertyHeader(boolean factModelPresent, boolean simplePropertyPresent) throws Exception {
        ...
        if (factModelPresent) {
            Map<String, FactModelTree.SimpleType> simplePropertiesMock = mock(SortedMap.class);
