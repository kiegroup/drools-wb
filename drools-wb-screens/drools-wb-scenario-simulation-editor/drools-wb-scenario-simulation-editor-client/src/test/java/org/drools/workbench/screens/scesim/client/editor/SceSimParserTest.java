...
public class SceSimParserTest {
    ...
    public void testFromStringParsing1() {
        ...
        final List<SceSimRow> enums = SceSimParser.fromString(content);
    ...
    public void testToString1() {
        final List<SceSimRow> content = new ArrayList<SceSimRow>() {{
            add(new SceSimRow("Fact",
                              "field",
                              "['a', 'b']"));
            add(new SceSimRow("A raw value"));
        }};

        final String enums = SceSimParser.toString(content);
        assertEquals(enums,
                     "'Fact.field' : ['a', 'b']\n" +
                             "A raw value\n");
    }
