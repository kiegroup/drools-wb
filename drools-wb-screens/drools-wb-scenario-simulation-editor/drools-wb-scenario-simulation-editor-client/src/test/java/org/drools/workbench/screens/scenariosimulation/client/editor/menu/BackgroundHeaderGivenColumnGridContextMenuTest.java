...
public class BackgroundHeaderGivenColumnGridContextMenuTest {
    ...
    private BackgroundHeaderGivenContextMenu backgroundHeaderGivenContextMenuSpy;
    ...
    public void setup() {
        ...
        backgroundHeaderGivenContextMenuSpy = spy(new BackgroundHeaderGivenContextMenu() {
    ...
    @Test
    public void show() {
        backgroundHeaderGivenContextMenuSpy.show(GridWidget.BACKGROUND, 0, 0);
        verify(backgroundHeaderGivenContextMenuSpy, times(1)).mapEvent(eq(appendColumnElementMock), isA(AppendColumnEvent.class));
        verify(backgroundHeaderGivenContextMenuSpy, times(1)).mapEvent(eq(prependColumnElementMock), isA(PrependColumnEvent.class));
    }
}
