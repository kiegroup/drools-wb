...
public class DSLEditorPresenterValidationTest {
    ...
    public void setUp() throws Exception {
        presenter = new DSLEditorPresenter(view) {
            {
                dslTextEditorService = new CallerMock(DSLEditorPresenterValidationTest.this.dslTextEditorService);
    ...
    public void commandIsCalled() throws Exception {
        ...
        doReturn(new ArrayList<ValidationMessage>()).when(dslTextEditorService).validate(any(Path.class),
                                                                                         anyString());
    ...
    public void callFailsAndCommandIsCalled() throws Exception {
        ...
        doThrow(new IOException()).when(dslTextEditorService).validate(any(Path.class),
                                                                       anyString());
