...
public class GuidedRuleTemplateEditorPresenterValidationTest {

    @Mock
    GuidedRuleTemplateEditorService service;

    GuidedRuleTemplateEditorPresenter presenter;

    @Before
    public void setUp() throws Exception {
        presenter = new GuidedRuleTemplateEditorPresenter(mock(GuidedRuleTemplateEditorView.class)) {
            {
                service = new CallerMock<>(GuidedRuleTemplateEditorPresenterValidationTest.this.service);
