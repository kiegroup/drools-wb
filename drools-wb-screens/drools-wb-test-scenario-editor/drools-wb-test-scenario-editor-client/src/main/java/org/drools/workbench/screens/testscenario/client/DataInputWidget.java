    ...
    public DataInputWidget(String factType,
        ...
        final EditTextCell fieldsCell = new EditTextCell() {
            ...
            public Set<String> getConsumedEvents() {
                final Set<String> originalConsumedEvents = super.getConsumedEvents();
                return new HashSet<String>() {{
                    add(BrowserEvents.DBLCLICK);
                    if (originalConsumedEvents != null) {
                        addAll(originalConsumedEvents);
                    }
                }};
            }
        };
        ...
        final Column<FactData, String> fieldsColumn = new Column<FactData, String>(fieldsCell) {
            ...
            public void onBrowserEvent(Cell.Context context,
                ...
                if (BrowserEvents.DBLCLICK.compareTo(event.getType()) == 0) {
                    ...
                    final FieldDataValues fieldDataValues = new FieldDataValues(object,
                                                                                factType);
                    fieldsDetails.addAttribute("Field values",
                                               fieldDataValues);
