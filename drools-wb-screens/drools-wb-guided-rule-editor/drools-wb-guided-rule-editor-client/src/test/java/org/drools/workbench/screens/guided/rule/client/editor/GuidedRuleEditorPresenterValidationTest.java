...
public class GuidedRuleEditorPresenterValidationTest {

    @Mock
    GuidedRuleEditorService service;

    GuidedRuleEditorPresenter presenter;

    @Before
    public void setUp() throws Exception {
        presenter = new GuidedRuleEditorPresenter(mock(GuidedRuleEditorView.class)) {
            {
                service = new CallerMock<>(GuidedRuleEditorPresenterValidationTest.this.service);
