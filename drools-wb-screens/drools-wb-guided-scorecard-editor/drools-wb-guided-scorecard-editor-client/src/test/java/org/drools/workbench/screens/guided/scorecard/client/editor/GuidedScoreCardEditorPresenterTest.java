...
public class GuidedScoreCardEditorPresenterTest {
    ...
    @Mock
    GuidedScoreCardEditorService scoreCardEditorService;
    ...
    public void commandIsCalled() throws Exception {
        ...
        doReturn(new ArrayList<ValidationMessage>()).when(scoreCardEditorService).validate(any(Path.class),
    ...
    public void callFailsAndCommandIsCalled() throws Exception {
        ...
        doThrow(new IOException()).when(scoreCardEditorService).validate(any(Path.class),
                                                                         any(ScoreCardModel.class));
